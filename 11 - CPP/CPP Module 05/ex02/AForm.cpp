...
/*   Updated: 2024/01/12 15:01:43 by berard           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AAForm::AForm(std::string name, int gradeSigned, int gradeExecuted) : _name(name), _signStatus(false), _gradeSigned(gradeSigned), _gradeExecuted(gradeExecuted)
{
